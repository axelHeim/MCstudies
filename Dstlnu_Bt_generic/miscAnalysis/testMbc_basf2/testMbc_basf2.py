# based on Gianna Mönig's steering file B_generic_apply_MC_Dstl_DXFEI.py she gave me ~May 2021
# altered by Axel Heimeroth Sep 2021


# to do
# move neutral cut online
# right FEI version
# right way for global tag
...
#uniqueParticleIdentifier uniqParID
    ...
    #alias_dict['Btag_decayModeID'] = 'daughter(0,extraInfo(decayModeID))'
    ...
    alias_dict['Hc_cmE']= 'useCMSFrame(daughter(0, daughter(0, E)))'
    alias_dict['Hc_cmPx']= 'useCMSFrame(daughter(0, daughter(0, px)))'
    alias_dict['Hc_cmPy']= 'useCMSFrame(daughter(0, daughter(0, py)))'
    alias_dict['Hc_cmPz']= 'useCMSFrame(daughter(0, daughter(0, pz)))'    
    
    alias_dict['Hc_E']= 'daughter(0, daughter(0, E))'
    alias_dict['Hc_Px']= 'daughter(0, daughter(0, px))'
    alias_dict['Hc_Py']= 'daughter(0, daughter(0, py))'
    alias_dict['Hc_Pz']= 'daughter(0, daughter(0, pz))'
...
"""     # added for BranchSeparator data creation
    ...
    for var in variables:
      ...
      # for X: all are daughter of X = dau0dau1
      for i in range(30): # root output shows no more than 25 daughters in X
        #continue
        alias_dict['X_dau{}_{}'.format(i,var)]= 'daughter(0,daughter(1,daughter({},{})))'.format(i,var)


      # for Bsig particles: Bsig = dau1
      # for Dst = dau1dau0 , depth of 2 for decay pions and kaons and possible pi0->2gamma
      for i in range(2): # maximum of 2 particles from Dst (D0 and K)
        alias_dict['Dst_dau{}_{}'.format(i,var)]= 'daughter(1,daughter(0,daughter({},{})))'.format(i,var)
        
      for i in range(2): # maximum of 2 gammas from pi0 (only at pos 2 or 4 (counting from 0))
        alias_dict['D0_pi0_2_gamma{}_{}'.format(i,var)]= 'daughter(1,daughter(0,daughter(0,daughter(2,daughter({},{})))))'.format(i,var)
        alias_dict['D0_pi0_4_gamma{}_{}'.format(i,var)]= 'daughter(1,daughter(0,daughter(0,daughter(4,daughter({},{})))))'.format(i,var)
...
# SKIM changed to release 05
#basf2.conditions.globaltags = ['analysis_tools_release-05-00-00']
...
cutAndCopyList('gamma:goodBelleGamma', 'gamma:myMinimumThresholdList', 
...
out_path = "/nfs/dust/belle2/user/axelheim/MC_studies/Dstlnu_Bt_generic/miscAnalysis/testMbc_basf2/"
...
variablesToNtuple('Upsilon(4S):DXtag',
		   ...
		   'extraInfo(FEIProbabilityRank)',
                  ...
                  filename= out_path + 'DXtagDstl_' + identifier + '.root',
                  path=path)
...
variablesToNtuple('gamma:goodBelleGamma', variables=outvars_FSPs, filename= out_path + "gammas_" + identifier + ".root", path=path)



process(path, max_event=15000)